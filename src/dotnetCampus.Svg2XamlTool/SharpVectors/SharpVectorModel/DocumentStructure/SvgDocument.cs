...
namespace SharpVectors.Dom.Svg
{
    ...
    public class SvgDocument : CssXmlDocument, ISvgDocument
    {
        ...
        private XmlReaderSettings GetXmlReaderSettings()
        {
            ...
            settings.DtdProcessing = DtdProcessing.Ignore;//                = DtdProcessing.Parse;

            settings.IgnoreComments = true;//               = _ignoreComments;
            settings.IgnoreWhitespace = true;//             = _ignoreWhitespace;
            settings.IgnoreProcessingInstructions = true;// _ignoreProcessingInstructions;
